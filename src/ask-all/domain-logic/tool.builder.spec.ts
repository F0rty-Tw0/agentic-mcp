...
describe('buildAskAllToolDefinition', () => {
  ...
  describe('input schema', () => {
    ...
    it('GIVEN definition WHEN called THEN providers field is optional array', () => {
      ...
      expect(def.inputSchema.providers).toBeDefined();

      const withProviders = (def.inputSchema.providers as z.ZodType).safeParse(['claude']);
      const withoutProviders = (def.inputSchema.providers as z.ZodType).safeParse(undefined);
