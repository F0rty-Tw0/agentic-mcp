export const SKILL_CONTENT_GUIDE_LINES = [
  ...
  '## prove Command Guide',
  '',
  'Use `prove` when you want the fastest canned real-answer check against a detected provider.',
  '',
  'Examples:',
  '',
  '```bash',
  'npx agentic-mcp prove',
  'npx agentic-mcp prove codex',
  'npx agentic-mcp prove claude --context "Focus on correctness"',
  '```',
  ...
  '| Mistake | Fix |',
  '| --- | --- |',
  '| Calling `ask_<provider>` before `list_providers` or `prove` | Discover detected providers first, then use `prove` for the fastest real answer |',
