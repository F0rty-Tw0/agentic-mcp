...
describe('resolveRequestedModel', () => {
  ...
  it('GIVEN valid model identifier WHEN called THEN verifies availability and returns args unchanged', async () => {
    const context = buildContext();
  ...
  it('GIVEN hyphenated shorthand model WHEN called THEN returns args with closest available model', async () => {
    const context = buildContext();
    const args: AskToolArgs = { prompt: 'hello', model: 'claude-sonnet-4' };
    const availableModels = 'claude-sonnet-4.6\nclaude-opus-4.6';
  ...
  it('GIVEN provider-qualified unavailable model WHEN called THEN returns args with closest available model', async () => {
    const context = buildContext();
    const args: AskToolArgs = { prompt: 'hello', model: 'openai/gpt-5.5' };
    const availableModels = 'openai/gpt-5.4\nopenai/gpt-5.3-codex';
  ...
  it('GIVEN ambiguous equally close matches WHEN called THEN returns args unchanged', async () => {
    const context = buildContext();
    const args: AskToolArgs = { prompt: 'hello', model: 'openai/gpt-5.4' };
