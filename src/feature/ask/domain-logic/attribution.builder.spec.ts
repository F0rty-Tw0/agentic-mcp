...
describe('buildAttribution', () => {
  ...
  describe('provider field', () => {
    it('GIVEN provider name "claude" WHEN buildAttribution called THEN provider is "claude"', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });

      expect(result.provider).toBe('claude');
    });

    it('GIVEN provider name "codex" WHEN buildAttribution called THEN provider is "codex"', () => {
      const result = buildAttribution({ provider: 'codex', model: undefined, result: BASE_RESULT, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });
  ...
  describe('model field', () => {
    it('GIVEN model "gpt-4" WHEN buildAttribution called THEN model is "gpt-4"', () => {
      const result = buildAttribution({ provider: 'codex', model: 'gpt-4', result: BASE_RESULT, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });
  ...
  describe('executionTimeMs field', () => {
    it('GIVEN executionTimeMs 1500 WHEN buildAttribution called THEN executionTimeMs is 1500', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: { ...BASE_RESULT, executionTimeMs: 1500 }, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });

      expect(result.executionTimeMs).toBe(1500);
    });

    it('GIVEN executionTimeMs 0 WHEN buildAttribution called THEN executionTimeMs is 0', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: { ...BASE_RESULT, executionTimeMs: 0 }, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });
  ...
  describe('outputBytes field', () => {
    it('GIVEN stdoutBytes 256 WHEN buildAttribution called THEN outputBytes is 256', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: { ...BASE_RESULT, stdoutBytes: 256 }, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });
  ...
  describe('truncated field', () => {
    it('GIVEN truncated false WHEN buildAttribution called THEN truncated is false', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: { ...BASE_RESULT, truncated: false }, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });

      expect(result.truncated).toBe(false);
    });

    it('GIVEN truncated true WHEN buildAttribution called THEN truncated is true', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: { ...BASE_RESULT, truncated: true }, outputFormat: 'text', metadata: undefined, sessionMode: 'none' });
  ...
  describe('outputFormat field', () => {
    it('GIVEN outputFormat "json" WHEN buildAttribution called THEN outputFormat is "json"', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'json', metadata: undefined, sessionMode: 'none' });

      expect(result.outputFormat).toBe('json');
    });

    it('GIVEN outputFormat "stream-json" WHEN buildAttribution called THEN outputFormat is "stream-json"', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'stream-json', metadata: undefined, sessionMode: 'none' });
  ...
  describe('sessionMode field', () => {
    ...
    it('GIVEN sessionMode "tier1-prepend" WHEN buildAttribution called THEN sessionMode is "tier1-prepend"', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'text', metadata: undefined, sessionMode: 'tier1-prepend' });
    ...
    it('GIVEN sessionMode "tier2-native" WHEN buildAttribution called THEN sessionMode is "tier2-native"', () => {
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'text', metadata: undefined, sessionMode: 'tier2-native' });
  ...
  describe('outputFormatObserved field', () => {
    it('GIVEN metadata with outputFormatObserved "json" WHEN buildAttribution called THEN outputFormatObserved is "json"', () => {
      ...
      const result = buildAttribution({ provider: 'claude', model: undefined, result: BASE_RESULT, outputFormat: 'json', metadata, sessionMode: 'none' });
  ...
  describe('full attribution shape', () => {
    it('GIVEN all fields WHEN buildAttribution called THEN returns complete ProviderAttribution', () => {
      ...
      const result = buildAttribution({ provider: 'gemini', model: 'gemini-pro', result: { ...BASE_RESULT, executionTimeMs: 2000, stdoutBytes: 512, truncated: true }, outputFormat: 'stream-json', metadata, sessionMode: 'tier1-prepend' });
